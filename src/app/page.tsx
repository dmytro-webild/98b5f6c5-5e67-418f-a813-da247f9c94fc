...
export default function LandingPage() {
  ...
  <div id="services" data-section="services">
      ...
      features={[
        { id: "s1", title: "Licensing", author: "", description: "Streamlined compliance management and professional assistance to navigate complex regulatory requirements efficiently.", tags: ["Licensing"], imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3CBGbboIMtOX8RWGiJBVajdKQEp/a-professional-business-consultant-works-1775854071916-b7c1afec.png?_wi=2" },
        { id: "s2", title: "Web & App Development", author: "", description: "Building custom digital experiences that drive value.", tags: ["Web Dev"], imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3CBGbboIMtOX8RWGiJBVajdKQEp/a-developer-working-on-app-code-high-end-1775854073276-67e16bab.png?_wi=2" },
        { id: "s3", title: "Marketing Strategy", author: "", description: "Crafting roadmaps that convert audiences to fans.", tags: ["Strategy", "Growth"], imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3CBGbboIMtOX8RWGiJBVajdKQEp/a-creative-marketing-strategy-session-wh-1775854072422-df01d47d.png?_wi=2" },
        { id: "s4", title: "Advertising", author: "", description: "Targeted campaigns that maximize your ROI.", tags: ["Ad", "Growth"], imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3CBGbboIMtOX8RWGiJBVajdKQEp/a-professional-digital-marketing-adverti-1775854073260-faefd7c4.png?_wi=2" },
        { id: "s5", title: "Digital-First Solutions", author: "", description: "Modern infrastructure for a modern business.", tags: ["Digital"], imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3CBGbboIMtOX8RWGiJBVajdKQEp/a-futuristic-digital-dashboard-data-visu-1775854071835-579ecde0.png?_wi=2" }
      ]}
